declare module 'xlsx-populate' {
	...
	class ArgHandler {
		 ...
		 */
		case(types?: string | Array<string>, handler: Function, ...args: any[]): ArgHandler;
		/**
	...
	class Cell {
		...
		*/
		 ...
		 * @ignore
		 */
		setSharedFormula(id: number, formula?: string, sharedRef?: string): undefined;
	...
	class RichTextFragment {
		 ...
		 */
		constructor(value: string | any, styles?: object | undefined | null, richText: RichText);
		_richText: RichText;
		_node: any;
		_fontNode: {};
		_valueNode: {};
	...
	class Sheet {
		...
		*/
		 ...
		 * @ignore
		 */
		_getCheckAttributeNameHelper(functionName: string, supportedAttributeNames: any[]): Function;
		/**
		 ...
		 * @ignore
		 */
		_getCheckRangeHelper(functionName: string, valueMin: undefined | number, valueMax: undefined | number): Function;
		/**
	...
	class Style {
		 ...
		 */
		constructor(styleSheet: StyleSheet, id: number, xfNode: {}, fontNode: {}, fillNode: {}, borderNode: {});
	...
	class Workbook {
		 ...
		 * @ignore
		 */
		static fromDataAsync(data: string | Array<number> | ArrayBuffer | Uint8Array | Buffer | Blob | Promise<any>, opts?: {}): Promise<Workbook>;
		/**
		...
		* @returns {Promise<string|Uint8Array|ArrayBuffer|Blob|Buffer>} The data.
		*/
		outputAsync(opts?: {}): Promise<string | Uint8Array | ArrayBuffer | Blob | Buffer>;
		/**
		...
		* @ignore
		*/
		scopedDefinedName(sheetScope: Sheet, name: string, refersTo: undefined | Cell | Range | Row | Column, ...args: any[]): Workbook;
		/**
	...
	declare module "xmlq" {
		 ...
		 */
		export function getChildAttribute(node: {}, name: string, attribute: string): any;
		/**
		 ...
		 * @returns {undefined}
		 */
		export function insertInOrder(node: {}, child: {}, nodeOrder: string[]): undefined;
		/**
		 ...
		 * @returns {{}} The child.
		 */
		export function setChildAttributes(node: {}, name: string, attributes: {}): {};
		/**
